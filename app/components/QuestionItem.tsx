              ...
              {isUserQuestion && isAuthenticated && (
                <div className="flex gap-2 flex-shrink-0">
                  <button
                    ...
                    className="text-xs px-2 py-1 bg-amber-100 text-amber-700 border border-amber-200 rounded hover:bg-amber-200 transition-colors flex items-center gap-1"
                  >
            ...
            {isAuthenticated && (
              <div className="flex justify-end mt-3">
                <button
                  ...
                  className="text-sm px-4 py-2 bg-blue-100 text-blue-700 border border-blue-200 rounded-md hover:bg-blue-200 transition-colors flex items-center gap-2"
                >
